...
## [解题思路]（https://leetcode.cn/problems/surrounded-regions/solutions/369110/bei-wei-rao-de-qu-yu-by-leetcode-solution/）
- 从边界处的'O'出发，所有与边界'O'连接的'O'被修改为‘#’
- 重新遍历矩阵， ‘#’还原为‘O', 剩下的'O'是被包围的位置，修改为'X'
